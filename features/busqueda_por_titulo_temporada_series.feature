...
Antecedentes:
    ...
    Y que existe la temporada "Pretty Little Liars - Temporada 2" 2010 "drama" 24 en la base de datos
    Y que existe la temporada "Pretty Little Liars - Temporada 3" 2011 "drama" 24 en la base de datos
