...
Antecedentes:
    ...
    Y que el contenido "Titanic" 1997 "drama" "pelicula" existe en la base de datos
    ...
    Escenario: US08 - 02 Como cinefilo quiero buscar una pelicula por su nombre parcial
        Dado que el contenido "Catch me if you can" 2002 "comedia" "pelicula" existe en la base de datos
    ...
    Escenario: US08 - 04 Como cinefilo quiero ver multiples peliculas que coincidan con mi criterio de busqueda
        Dado que el contenido "Titan" 2001 "accion" "pelicula" existe en la base de datos
